...
DEFAULT_BENCHMARKS = {
    "web": PACKAGE_ROOT / "benchmarks" / "web_service_workload.py",
    "ads": PACKAGE_ROOT / "benchmarks" / "ads_recommendation_workload.py",
    "data_structures": PACKAGE_ROOT / "benchmarks" / "data_structures_workload.py",
    "analytics": PACKAGE_ROOT / "benchmarks" / "analytics_workload.py",
...
<body>
  ...
  <table>
    <tr>
      ...
      <th>Working set pages</th><th>Details</th>
    </tr>
    {rows}
  </table>
</body>
